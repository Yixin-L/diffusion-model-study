...
Date: 2025-02-17 18:18:49
LastEditors: Yixin Liu yixin_lucy@163.com
LastEditTime: 2025-02-17 21:28:21
FilePath: \DDPM\ddpm\sample.py
...
if __name__ == "__main__":
    ...
    model.to(device)
    #scheduler = NoiseScheduler(device=device) bug
